// main.js - 原神方向标记插件（字幕版）v1.1.1
// 适配 Plugin API v2 - 使用扁平化全局对象

/**
 * 从文本中提取方向信息
 * 支持：东/西/南/北、东北/东南/西北/西南
 * 支持：小地图右上/右下/左上/左下/右/左/上/下 + 可选口语连接词和后缀
 * 支持：各种后缀（方向、边、方、侧、手边）
...
function extractDirections(text) {
    ...
    // 第二部分：地图 + 可选“的/这/这个/那/那个” + 方向 + 可选后缀
    var directionRegex = /(东北|东南|西北|西南|东|西|南|北)(?:方向|边|方|侧)?|(?:小?)地图(?:的)?\s*(?:(?:这|那)(?:个)?\s*)?(右上|右下|左上|左下|右|左|上|下)(?:边|方|手边|侧|面)?/g;
